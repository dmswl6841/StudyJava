...
//
//
//Question 2] Human - StandardWeightInfo 상속 / StandardWeightInfo - ObesityInfo 상속
//1) Human 클래스를 정의한다.
//	- 이름과 키, 몸무게를 필드로 가지며 생성자를 이용하여 값을 초기화한다.
//	- 메소드는 다음과 같이 정의한다.
//	(1) public void getInformation() : 이름, 키와 몸무게를 출력하는 기능
//	
//2) StandardWeightInfo 클래스를 정의한다. 인스턴스로만 선언
//	- Human 클래스를 상속한다.
//	- 메소드는 다음과 같이 정의한다.
...
//
//3) ObesityInfo 클래스를 정의한다. 인스턴스로만 선언
...
//	
//
//Question 3] : Culture - Movie / Performance 상속
